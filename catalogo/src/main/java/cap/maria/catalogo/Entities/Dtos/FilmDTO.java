...
public class FilmDTO {
    ...
    public static FilmDTO from(Film source){
        return new FilmDTO(
                    source.getFilmId(), 
                    source.getTitle(), 
                    source.getLanguage()!= null ? source.getLanguage().getLanguageId() : 0,
    ...
    public static Film from(FilmDTO dto){
        ...
        film.setRentalRate(BigDecimal.valueOf(dto.getRentalRate()));
        film.setReplacementCost(BigDecimal.valueOf(dto.getCost()));
